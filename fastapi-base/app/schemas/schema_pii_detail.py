...
class PIIDetailCreate(BaseModel):
    """Schema tạo PII Detail"""
...
class PIIDetailResponse(BaseModel):
    """Schema response PII Detail"""
    id: int
    province: str
    period_type: str
    year: int
...
class PIIDetailListResponse(BaseModel):
    """Schema list response"""
    total: int
    page: int = 1
    page_size: int = 50
    total_pages: int = 1
    data: list[PIIDetailResponse]
